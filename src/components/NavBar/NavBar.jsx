...
export default function NavBar ({setUser}) {
    ...
    return (
        <>
            <div className="fixed top-0 w-screen h-16 px-6 bg-midnight-blue justify-between items-center gap-8 inline-flex">
            ...
            {
                menuOpen &&
                <CSSTransition in={menuOpen} timeout={5000} classNames="fade" unmountOnExit>
                    <div className="flex bg-gradient-to-b from-midnight-blue to-rgb(255,196,126) top-16 left-0 fixed h-screen w-full flex-col p-10">
