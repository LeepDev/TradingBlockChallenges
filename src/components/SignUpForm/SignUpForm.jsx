...
export default class SignUpForm extends Component {
    ...
    render() {
        ...
        return (
            <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto mt-0 sm:mt-20">
                ...
                <div class="w-full rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-midnight-blue dark:border-midnight-blue">
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form class="space-y-4 md:space-y-6" autoComplete="off" onSubmit={this.handleSubmit}>
                            ...
                            <button type="submit" disabled={disable} class="w-full text-white bg-teal hover:bg-teal/70 focus:ring-4 focus:outline-none focus:border-primary-600  font-medium rounded-lg text-sm px-5 py-2.5 text-center">Sign Up</button>
                            {
                                this.state.error ? 
