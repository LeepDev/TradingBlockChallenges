...
export default function App() {
  ...
  return (
    <div className='w-screen h-screen antialiased overflow-hidden'>
      ...
      { 
        user ? 
        <main className="bg-gradient-to-b from-midnight-blue to-rgb(255,196,126) w-screen h-screen flex-ctr-ctr flex-col fixed top-16 overflow-y-auto pb-20">
              <Routes>
        ...
        :
        <main className="bg-gradient-to-b from-midnight-blue to-rgb(255,196,126) w-screen h-screen flex-ctr-ctr flex-col overflow-auto">
