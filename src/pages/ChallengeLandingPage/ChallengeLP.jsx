export default function ChallengeLP() {
    return (
    <div className="bg-gradient-to-b from-midnight-blue to-rgb(255,196,126) h-screen w-full flex flex-ctr-ctr flex-col pt-16">
        <div className="flex-ctr-ctr flex-col rounded-xl bg-midnight-blue w-11/12 px-10 py-5 border border-teal/10 shadow-teal shadow-2xl xl:mt-0 lg:mt-10 md:mt-40 sm:mt-72 mt-[32rem]">
